...
public class IssueBookListImpl implements BaseAction {
	...
	public void doHttpReqRes(HttpServletRequest request, HttpServletResponse response) throws IOException {
		...
		Map<String, List<IssueBook>> issueBooks = dao.issueBookReport(issueBook);
		...
		if (issueBooks != null) {
			...
			String answer = noDataReply.noDataReceived("IssueBookListImpl", "IssueBook");
			out.print(answer);
			out.close();
		}
