...
public class EmployeeListFilterImpl implements BaseAction {
	...
	public void doHttpReqRes(HttpServletRequest request, HttpServletResponse response) throws IOException {
		...
		Map<String, List<Employee>> employes = dao.findEmployee(employee);
		...
		if (employes != null) {
			...
			String answer = noDataReply.noDataReceived("EmployeeListFilterImpl", "Employee");
			out.print(answer);
			out.close();
		}
