...
import by.htp.library.action.manager.ActionManagerServices;
...
@WebServlet("/ServletControllerServices")
public class ServletControllerServices extends HttpServlet implements Filter {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		synchronized (this) {
			...
			BaseAction action = ActionManagerServices.defineAction(value);
