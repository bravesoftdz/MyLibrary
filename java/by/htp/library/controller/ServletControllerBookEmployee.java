...
import by.htp.library.action.manager.ActionManagerBookEmployee;
...
@WebServlet("/ServletControllerBookEmployee")
public class ServletControllerBookEmployee extends HttpServlet implements Filter {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		synchronized (this) {
			...
			BaseAction action = ActionManagerBookEmployee.defineAction(value);
