...
import by.htp.library.action.manager.ActionManagerEmployee;
...
@WebServlet("/ServletControllerEmployee")
public class ServletControllerEmployee extends HttpServlet implements Filter {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		synchronized (this) {
			...
			BaseAction action = ActionManagerEmployee.defineAction(value);
